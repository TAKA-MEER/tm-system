...
def generate_launch_description():
    return LaunchDescription([
        ...
        # ダミーデータパブリッシャ
        Node(package='tm_system_bringup', executable='dummy_lidar_publisher',
             name='dummy_lidar_publisher', output='screen'),
        Node(package='tm_system_bringup', executable='dummy_manual_target_publisher',
             name='dummy_manual_target_publisher', output='screen'),
        Node(package='tm_system_bringup', executable='dummy_manual_vel_publisher',
             name='dummy_manual_vel_publisher', output='screen'),
    ])
